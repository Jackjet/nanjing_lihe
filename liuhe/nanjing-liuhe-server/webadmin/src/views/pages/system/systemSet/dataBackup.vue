      ...
      <el-form v-loading="loading" :model="baseForm" :rules="rules" ref="baseForm" label-width="150px">
        <el-row class="top">
          <el-form-item label="数据库类型:" :label-width="this.formLabelWidth" prop='name'>
            <el-input clearable maxlength='100' size="small" :disabled="disabled" placeholder="请输入数据库类型" v-model="baseForms.type"></el-input>
          </el-form-item>
          <el-form-item label="数据库名称:" :label-width="this.formLabelWidth" prop='name'>
            <el-input clearable maxlength='100' size="small" :disabled="disabled" placeholder="请输入数据库名称" v-model="baseForms.name"></el-input>
          </el-form-item>
          <el-form-item label="备份数据大小:" :label-width="this.formLabelWidth" prop='name'>
            <el-input clearable maxlength='100' size="small" :disabled="disabled" placeholder="请输入备份数据大小" v-model="baseForms.size"></el-input>
          </el-form-item>
          ...
          <el-form-item style="dispaly: flex; " prop='hour' label="请填写相应周期:" :label-width="this.formLabelWidth" v-if="baseForm.cronType === '0'">
            <el-col :span="8">
              <el-form-item prop='hour'>
                <el-input-number v-model="baseForm.hour" :disabled="disabledo" controls-position="right" :min="0" :max="23"></el-input-number><span style="padding: 10px">时</span>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item prop='minute'>
                <el-input-number v-model="baseForm.minute" :disabled="disabledo" controls-position="right" :min="0" :max="60"></el-input-number><span style="padding: 10px">分</span>
              </el-form-item>
            </el-col>
          </el-form-item>
          ...
          <el-form-item label="备份路径:" prop='path' :label-width="this.formLabelWidth">
            <el-input clearable maxlength='100' size="small" :disabled="disabledo" placeholder="请输入英文和数字类型的备份路径例如/root/backup/" v-model="baseForm.path"></el-input>
          </el-form-item>
          ...
          <div v-if="!isActive" style="text-align: center;">
            <el-button size="small" @click="cancal('baseForm')">取 消</el-button>
            <el-button size="small" type="primary" @click="submitForm('baseForm')">保 存</el-button>
          </div>
          <div v-if="isActive" style="text-align: center;">
