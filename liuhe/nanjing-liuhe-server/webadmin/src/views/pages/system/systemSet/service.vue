    ...
    <el-col class="main-center">
      <el-form v-loading="loading" :model="ruleForm" ref="ruleForm" style="width: 80%; margin: 0 auto;">
        <el-form-item label="系统类型:" :label-width="this.formLabelWidth" prop='name'>
          <el-input size="small" :disabled="true" v-model="ruleForm.osName"></el-input>
        </el-form-item>
        <el-form-item label="硬盘大小:" :label-width="this.formLabelWidth" prop='name'>
          <el-input size="small" :disabled="true" v-model="ruleForm.total"></el-input>
        </el-form-item>
        <el-form-item label="已用硬盘大小:" :label-width="this.formLabelWidth" prop='name'>
          <el-input size="small" :disabled="true" v-model="ruleForm.used"></el-input>
        </el-form-item>
        <el-form-item label="内存大小:" :label-width="this.formLabelWidth" prop='name'>
          <el-input size="small" :disabled="true" v-model="ruleForm.memTotal"></el-input>
        </el-form-item>
        <el-form-item label="已用内存大小:" :label-width="this.formLabelWidth" prop='name'>
          <el-input size="small" :disabled="true" v-model="ruleForm.memRam"></el-input>
        </el-form-item>
        <el-form-item label="CPU已用百分比:" :label-width="this.formLabelWidth" prop='name'>
          <el-input size="small" :disabled="true" v-model="ruleForm.combined"></el-input>
        </el-form-item>
      </el-form>
    </el-col>
  </el-main>
