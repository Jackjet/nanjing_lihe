    ...
    <el-col class="main-center">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
        <el-form-item label="父级组织机构:" :label-width="this.formLabelWidth">
          <el-input clearable maxlength='100' size="small" disabled="true" placeholder="" v-model="ruleForm.parentName"></el-input>
        </el-form-item>
        <el-form-item label="层级:" :label-width="this.formLabelWidth">
          <el-input maxlength='100' clearable size="small" disabled="true" v-model="ruleForm.levelMsg"></el-input>
        </el-form-item>
        <el-form-item label="组织机构名称:" :label-width="this.formLabelWidth" prop='name'>
          <el-input maxlength='100' placeholder="请输入组织机构名称" clearable size="small" v-model="ruleForm.name"></el-input>
        </el-form-item>
