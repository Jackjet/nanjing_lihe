<template>
  <el-main>
    <el-col :span="24">
      <el-form :inline="true" class='el-InputForm'>
        <el-form-item label="姓名">
          <el-input clearable size="small" placeholder="请输入姓名" v-model="SearchItem.name">
          </el-input>
        </el-form-item>
        <el-form-item label="账号">
          <el-input clearable size="small" placeholder="请输入账号" v-model="SearchItem.account">
          </el-input>
        </el-form-item>
        <el-form-item label="手机号">
          <el-input clearable size="small" placeholder="请输入手机号" v-model="SearchItem.phone">
          </el-input>
        </el-form-item>
        <el-form-item label="组织机构">
          <el-input clearable size="small" placeholder="请输入组织机构" v-model="SearchItem.organizationName">
          </el-input>
        </el-form-item>
    ...
    <el-col :span="24" style="margin-top: 10px;">
      ...
      <el-upload style="display: inline-block; margin: 0 10px;" ref="upload" :headers='headers' :action="action" :on-preview="handlePreview" :on-remove="handleRemove" :on-success="handleSuccess" :before-remove="beforeRemove" :on-error="hadleError" limit="1" :on-exceed="handleExceed" :file-list="fileList">
