  ...
  <el-main>
    <el-col :span="24">
      <el-form :inline="true" class='el-InputForm'>
        ...
        <el-form-item label="消息主题">
          <el-input clearable size="small" placeholder="请输入消息主题" v-model="SearchItem.messageTitle">
          </el-input>
        </el-form-item>
        <el-form-item label="来源">
          <el-input clearable size="small" placeholder="请输入来源" v-model="SearchItem.messageModule">
          </el-input>
        </el-form-item>
    ...
    <el-col :span="24" class="center">
      <div style="padding-top: 20px;">
        <el-button type="primary" v-permission="allRead" plain size='small' @click="allStatusAll" icon="el-icon-bottom-left">全部已读</el-button>
        <el-button type="primary" v-permission="batchRead" plain size='small' @click="status" icon="el-icon-top-right">批量已读</el-button>
        <el-button type="primary" v-permission="batchDelete" plain size='small' @click="handleDelete" icon="el-icon-delete">批量删除</el-button>
      </div>
