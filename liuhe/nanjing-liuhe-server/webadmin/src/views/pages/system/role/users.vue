     ...
     <el-col :span="24">
      <el-form :inline="true" class='el-InputForm'>
        ...
        <el-form-item style='margin-left: 15px;'>
          <el-button size='small' @click="SearchNoteList" style="color: #5677DF" icon="el-icon-search">查询</el-button>
          <el-button  size='small' @click="reset" icon="el-icon-refresh-left" style="color: #5677DF">重置</el-button>
        </el-form-item>
      </el-form>
    </el-col>
