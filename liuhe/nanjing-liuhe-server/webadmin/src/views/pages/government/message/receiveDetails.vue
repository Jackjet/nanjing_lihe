  ...
  <el-main class="main">
    ...
    <el-col class="main-center">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
        ...
        <el-form-item label="*联系人：" prop="sortNumber">
          <el-input v-model="ruleForm.sortNumber" :disabled="type==='detail'" placeholder="输入序号"></el-input>
        </el-form-item>
        <el-form-item label="*联系方式" prop="sortNumber">
          <el-input v-model="ruleForm.sortNumber" :disabled="type==='detail'" placeholder="输入序号"></el-input>
        </el-form-item>
        <el-form-item label="附件" prop="imagesPaht" ref="image">
