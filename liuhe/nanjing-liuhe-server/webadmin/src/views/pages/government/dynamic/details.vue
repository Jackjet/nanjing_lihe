    ...
    <el-col class="main-center">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="组织部门:" :label-width="this.formLabelWidth" prop="organization">
          <el-cascader :show-all-levels="false" style="width: 100%;" placeholder="请选择组织部门" :props="props" :disabled="disabled" collapse-tags clearable v-model="ruleForm.organization" :options="organizationOptions"  />
        </el-form-item>
        ...
        <el-form-item label="当前阶段" prop="stage">
          <el-select style="width:100%" v-model="ruleForm.stage" :disabled="type==='detail'" placeholder="请选择分类">
        ...
        <el-form-item label="开始时间">
          <el-date-picker v-model="ruleForm.startTime" value-format="yyyy-MM-dd" type="date" placeholder="选择开始时间">
          </el-date-picker>
        </el-form-item>
        <el-form-item label="结束时间">
          <el-date-picker v-model="ruleForm.endTime" value-format="yyyy-MM-dd" type="date" placeholder="选择结束时间">
          </el-date-picker>
        </el-form-item>
...
import { save, update, findById } from '@/api/government/dynamic';
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          if (this.ruleForm.startTime) {
            this.ruleForm.startTime = new Date(this.ruleForm.startTime).getTime()
          }
