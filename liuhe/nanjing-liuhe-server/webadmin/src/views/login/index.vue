<template>
  <div class="login-container">
    ...
    <el-dialog append-to-body :visible.sync="dialogVisible" :show-close="false" width="450px">
      <slideverify ref="dialogopen" :l="42" :r="10" :w="410" :h="200" :block_y="block_y" :imgurl="imgurl" :miniimgurl="miniimgurl" @success="imageVerifySuccess" @fail="imageVerifyFail" @refresh="imageVerifyRefresh" :slider-text="text">
      </slideverify>
    </el-dialog>
  </div>
</template>
