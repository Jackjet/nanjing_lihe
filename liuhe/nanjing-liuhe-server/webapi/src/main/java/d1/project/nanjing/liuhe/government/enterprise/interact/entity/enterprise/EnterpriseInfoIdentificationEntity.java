 ...
 **/
@Entity
@Table(name = "d1_zqhd_enterprise_identification")
@ApiModel(value = "EnterpriseInfoIdentification", description = "企业认证信息")
public class EnterpriseInfoIdentificationEntity extends BaseCreateAndUpdateEntity {
