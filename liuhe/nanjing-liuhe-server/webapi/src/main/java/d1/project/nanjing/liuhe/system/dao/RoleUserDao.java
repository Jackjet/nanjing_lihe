package d1.project.nanjing.liuhe.system.dao;

import d1.project.nanjing.liuhe.common.model.IId;
...
public interface RoleUserDao extends JpaRepository<RoleUserEntity, String>, JpaSpecificationExecutor<RoleUserEntity> {
    ...
    @Query(value = "select new d1.project.nanjing.liuhe.system.model.vm.WebAdminUserBaseVm(waue.id, waue.name, waue.phone, waue.account, waue.organizationName, waue.roleName) " +
