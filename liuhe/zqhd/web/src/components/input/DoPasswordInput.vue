...
-->
<template>
  <el-input maxlength='100' size="mini" :type="inputType" :value="text" placeholder="请输入密码" @input="handlePasswordInput">
    <i slot="suffix" @click="showPwd" v-show="isShow" style="position: relative; top: 8px;">
      <!-- 打开眼睛的图标-->
